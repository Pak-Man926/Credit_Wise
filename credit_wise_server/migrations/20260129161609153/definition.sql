...
--
-- Class Users as table auth_user
--
...
CREATE UNIQUE INDEX "user_info_id_unique" ON "auth_user" USING btree ("userInfoId");

--
-- Class CreditPrediction as table credit_prediction
--
...
--
-- Class CreditPreference as table credit_preference
--
...
--
-- Class LoanPrediction as table loan_prediction
--
...
--
-- Class LoanPreference as table loan_preference
--
...
--
-- Class ProfileData as table profile_data
--
...
--
-- Foreign relations for "auth_user" table
--
ALTER TABLE ONLY "auth_user"
    ADD CONSTRAINT "auth_user_fk_0"
...
--
-- Foreign relations for "credit_prediction" table
--
...
--
-- Foreign relations for "credit_preference" table
--
...
--
-- Foreign relations for "loan_prediction" table
--
...
--
-- Foreign relations for "loan_preference" table
--
...
--
-- Foreign relations for "profile_data" table
--
